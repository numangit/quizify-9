    ...
    return (
        <div className="d-block align-items-center d-lg-flex flex-lg-row-reverse mt-lg-4">
            ...
            <div className="mx-auto p-3 p-md-4 mt-lg-5">
                ...
                <Link to={window.location == 'http://localhost:3000/home' ? "../blog" : "blog"}><button type="button" className="btn btn-outline-success btn-lg m-1 m-md-3">Learn More  <FontAwesomeIcon icon={faAngleDoubleRight} /></button></Link>
            </div>
        </div>
    );
};
