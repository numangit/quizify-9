    ...
    return (
        ...
        <div className="d-flex my-4 col-lg-7 col-12 mx-auto  bg-card text-white p-2 rounded-3">
            ...
            <div className='mx-auto'>
                ...
                <p className=" my-1 py-0">Practice and test your {name} by answering our quiz. The more you practice the better you get! </p>
                <p className=" my-2 py-0 "><small><span className="fw-semibold">Total Quiz : </span>{total}</small></p>
                <Link className=" my-2 py-0 " ><button className="btn btn-dark btn-sm rounded-pill fw-bolder">Start Practice</button></Link>
            </div>
        </div>
    );
};
